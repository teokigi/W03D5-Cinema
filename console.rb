...
while loop_program == "1"
    ...
    case gets.chomp
        ...
        when "2"
            ...
            ticket01 = Ticket.new({'customer_id'=>customer01.id,'screening_id'=>screening1.id})
            ticket01.save
            ticket02 = Ticket.new({'customer_id'=>customer01.id,'screening_id'=>screening2.id})
            ticket02.save
            ticket03 = Ticket.new({'customer_id'=>customer02.id,'screening_id'=>screening3.id})
            ticket03.save
            ticket04 = Ticket.new({'customer_id'=>customer02.id,'screening_id'=>screening1.id})
            ticket04.save
            ticket05 = Ticket.new({'customer_id'=>customer03.id,'screening_id'=>screening2.id})
            ticket05.save
            ticket06 = Ticket.new({'customer_id'=>customer03.id,'screening_id'=>screening3.id})
            ticket06.save
            ticket07 = Ticket.new({'customer_id'=>customer04.id,'screening_id'=>screening4.id})
            ticket07.save
            ticket08 = Ticket.new({'customer_id'=>customer04.id,'screening_id'=>screening1.id})
            ticket08.save
            ticket09 = Ticket.new({'customer_id'=>customer05.id,'screening_id'=>screening2.id})
            ticket09.save
            ticket10 = Ticket.new({'customer_id'=>customer05.id,'screening_id'=>screening3.id})
            ticket10.save
            ticket11 = Ticket.new({'customer_id'=>customer06.id,'screening_id'=>screening4.id})
            ticket11.save
            ticket12 = Ticket.new({'customer_id'=>customer06.id,'screening_id'=>screening5.id})
            ticket12.save
            ticket13 = Ticket.new({'customer_id'=>customer07.id,'screening_id'=>screening1.id})
            ticket13.save
            ticket14 = Ticket.new({'customer_id'=>customer07.id,'screening_id'=>screening2.id})
            ticket14.save
            ticket15 = Ticket.new({'customer_id'=>customer08.id,'screening_id'=>screening3.id})
            ticket15.save
            ticket16 = Ticket.new({'customer_id'=>customer08.id,'screening_id'=>screening4.id})
            ticket16.save
            ticket17 = Ticket.new({'customer_id'=>customer09.id,'screening_id'=>screening5.id})
            ticket17.save
            ticket18 = Ticket.new({'customer_id'=>customer09.id,'screening_id'=>screening6.id})
            ticket18.save
            ticket19 = Ticket.new({'customer_id'=>customer10.id,'screening_id'=>screening1.id})
            ticket19.save
            ticket20 = Ticket.new({'customer_id'=>customer10.id,'screening_id'=>screening2.id})
            ticket20.save
            p "table repopulated."
        when "3"
            p "Enter Customer id"
